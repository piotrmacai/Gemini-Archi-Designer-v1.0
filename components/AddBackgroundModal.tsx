...
const AddBackgroundModal: React.FC<AddBackgroundModalProps> = ({ isOpen, onClose, onFileSelect }) => {
  if (!isOpen) {
    return null;
  }
    ...
    >
      ...
      >
        ...
        <div className="text-center">
          <h2 className="text-2xl font-extrabold mb-4 text-zinc-800 dark:text-gray-100">Upload a Background Image</h2>
        </div>
        <ImageUploader id="custom-background-uploader" onFileSelect={onFileSelect} imageUrl={null} />
      </div>
    </div>
  );
};
